...
const USERS_KEY = "billmetro_users";
const LOGGEDIN_KEY = "billmetro_loggedInUser";
const INVOICES_KEY = "billmetro_invoices";

// Initialize admin user if not exists
function initAdmin() {
  const users = JSON.parse(localStorage.getItem(USERS_KEY)) || [];
  const adminExists = users.find(u => u.email === "admin@billmetro.com");
